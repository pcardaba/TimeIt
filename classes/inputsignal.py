...
class InputSignal(Signal):
    def __init__(self, name):
        ...
        self.refclock = None
        self.rclk_inputdly_max = None
        self.rclk_inputdly_min = None
        self.fclk_inputdly_max = None
        self.fclk_inputdly_min = None
    ...
    def draw(self, canvas: tk.Canvas, top: int):
        ...
        try:
            for attr, key in (
                ...
                if attr is not None:
                    self.indly[key] = float(self.interp.eval("expr {"+attr+"}"))
        except tk.TclError as e:
    ...
    ## Only supporting external delays... TODO: add also internal delay option.
    def _get_input_delays(self, canvas, edge_item):
